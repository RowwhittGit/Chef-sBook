...
export default function ImgBBUploader({ onUploadComplete, currentImage }) {
  ...
  const uploadToImgBB = async (file) => {
    ...
    try {
      ...
      const response = await fetch(`https://api.imgbb.com/1/upload?key=RfBPDy8PcQhXkENW3VemgssElrk`, {
        method: "POST",
        body: formData,
      })
        ...
        <div className="flex flex-col items-center justify-center w-full">
          ...
          >
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              ...
              <p className="text-xs text-gray-500">PNG, JPG or JPEG (MAX. 32MB)</p>
            </div>
          </label>
          <input
            id="image-upload"
