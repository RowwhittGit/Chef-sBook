  ...
  const fetchPostData = async () => {
    try {
      ...
      setFormData({
        ...
        category_id: postData.category ? postData.category.id : "",
      })
      
      // Set preview if image exists
      if (postData.image_url) {
        setPreview(postData.image_url)
      }
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-orange-500 to-red-500 px-8 py-12 text-center">
            ...
            <h1 className="text-4xl font-bold text-white mb-2">Update Recipe</h1>
            <p className="text-orange-100 text-lg">Make your culinary masterpiece even better</p>
          </div>
                  ...
                  >
                    {isUploading ? (
                      ...
                      <>
                        ...
                        <span className="text-gray-600 font-medium">Click to upload new recipe photo</span>
